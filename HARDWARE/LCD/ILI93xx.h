...
//#define TURN_COLOR 1  // 翻转颜色，如果不需要就注释 有bug
#define LCD_ID_9341 0X9341  // 如果不是这个型号请注释这句，为了减少大小 teng
#define TFTLCD_DIR_MODE 0  //  0，竖屏；1，横屏
//#define XLCD_W 240
//#define XLCD_H 320
...
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size, u8 mode, u16 color);  						//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size, u8 mode, u16 color);				//显示 数字
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p, u8 mode, u16 color);		//显示一个字符串,12/16字体
