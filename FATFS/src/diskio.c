...
u16	    FLASH_SECTOR_COUNT=2048*8;	//W25Q1218,前12M字节给FATFS占用
...
)
{
	...
	switch(pdrv)
	{
		case SD_CARD://SD卡
				...
				SD_Init();	//初始化SD卡SDIO
#else               //teng
				SD_Initialize();  //初始化SD卡SPI     teng
#endif              //teng  			
		break;
		case EX_FLASH://外部flash
			W25QXX_Init();
			FLASH_SECTOR_COUNT=2048*8;//W25Q1218,前12M字节给FATFS占用 
 			break;
		default:
			res=1; 
	}		 
