		      ...
		      JSAMPARRAY output_buf)
{
	...
	for (col = cinfo->output_width >> 1; col > 0; col--) 
	{
		...
		TFTLCD->LCD_RAM = (range_limit[y + cblue] >> 3)<<11 | (range_limit[y + cgreen] >> 2) << 5 | range_limit[y + cred] >> 3;
		      ...
		      JSAMPARRAY output_buf)
{
	...
	for (col = cinfo->output_width >> 1; col > 0; col--) 
	{
		...
		TFTLCD->LCD_RAM = range_limit[y + cblue] >> 3 | (range_limit[y + cgreen] >> 2) << 5 | (range_limit[y + cred] >> 3) << 11;
